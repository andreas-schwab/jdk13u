...
class LIR_OpBranch: public LIR_Op {
 ...
 public:
  LIR_OpBranch(LIR_Condition cond, BasicType type,
#ifdef RISCV64
               LIR_Opr left,
               LIR_Opr right,
#endif
...
class LIR_List: public CompilationResourceObj {
 ...
 public:
  ...
  void jump(BlockBegin* block) {
    append(new LIR_OpBranch(lir_cond_always, T_ILLEGAL,
#ifdef RISCV64
  ...
  void branch(LIR_Condition cond, BasicType type,
#ifdef RISCV64
              LIR_Opr left,
              LIR_Opr right,
#endif
              Label* lbl) {
    append(new LIR_OpBranch(cond, type,
#ifdef RISCV64
           left, right,
#endif
           lbl));
